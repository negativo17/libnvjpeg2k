...
Source0:        https://developer.download.nvidia.com/compute/nvjpeg2000/redist/libnvjpeg_2k/linux-x86_64/libnvjpeg_2k-linux-x86_64-%{version}_cuda%{cuda_version}-archive.tar.xz
...
%prep
%ifarch x86_64
%setup -q -n libnvjpeg_2k-linux-x86_64-%{version}_cuda%{cuda_version}-archive
%endif

%ifarch aarch64
%setup -q -T -b 1 -n libnvjpeg_2k-linux-sbsa-%{version}_cuda%{cuda_version}-archive
%endif
